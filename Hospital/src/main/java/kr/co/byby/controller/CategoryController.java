...
public class CategoryController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/symCategory")
	public String getSymCategory() {
		return "/symBoard/symCategory";
	}
	
	//GET
	@RequestMapping(method = RequestMethod.GET, value = "/symCategoryData", produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String getSymCategoryData() {
		logger.debug("CALL getCategory Method: ");
		CategoryVO category = new CategoryVO();
		List<CategoryVO> categoryList = categoryService.getSymCategory(category);
		String json = new Gson().toJson(categoryList);
		return json;
	}
}
