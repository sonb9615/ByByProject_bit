...
Issues:
 * https://github.com/imsky/holder/issues
License:
...
document.querySelectorAll || (document.querySelectorAll = function (e) {
    ...
    for (
        ...
        document._qsa = [],
        r.styleSheet.cssText = e + "{x-qsa:expression(document._qsa && document._qsa.pu" +
                "sh(this))}",
        window.scrollBy(0, 0),
...
function () {
    function e(t, r, n) {
        ...
        var i,
            o = t
                .currentStyle[r]
                .match(/([\d\.]+)(%|cm|em|in|mm|pc|pt|)/) || [
                    0, 0, ""
                ],
            a = o[1],
            l = o[2];
        return n = n
            ? /%|em/.test(l) && t.parentElement
...
function (e, t) {
    ...
    var e = function () {},
        ...
        r = function (r, n) {
            var i = e.prototype = "function" == typeof r
                    ? r.prototype
                    : r,
                o = new e,
...
function (e, t) {
    ...
    function n(e, t) {
        for (
            ...
            if (A.flags.dimensions.match(d)) 
                ...
                t
                    .themes
                    .hasOwnProperty(d) && (r.theme = p(t.themes[d], null)),
                u = !0;
                ...
                null == A.vars.cache.themeKeys && (
                    A.vars.cache.themeKeys = Object.keys(t.themes)
                );
                var f = A
                    .vars
                    .cache
                    .themeKeys[0 | Math.random() * A.vars.cache.themeKeys.length];
    ...
    function i(e, t, r, n) {
        ...
        r.font && (
            a.font = r.font,
            !g.noFontFallback && "img" === t.nodeName.toLowerCase() && A.setup.supportsCanvas && "svg" === g.renderer && (g = p(g, {renderer: "canvas"}))
        ),
        r.font && "canvas" == g.renderer && (g.reRender = !0),
        "background" == e
            ? null == t.getAttribute("data-background-src") && c(
                t,
    ...
    function o(e, t, r, n) {
        ...
        "background" == e
            ? (
                ...
                r.style.backgroundSize = l.width + "px " + l.height + "px"
            )
            : (
                ...
                n.reRender && setTimeout(function () {
                    ...
                    "img" === r
                        ...
                        .toLowerCase()
                            ...
                            : "object" === r
                                .nodeName
                                .toLowerCase() && (c(r, {data: e}), c(r, {type: "image/svg+xml"}))
                }, 100)
            ),
        c(r, {
    ...
    function a(e) {
        ...
        switch (
            ...
            case "exact":
                if (!e.flags.exactDimensions) 
                    break;
                e.text = Math.floor(e.flags.exactDimensions.width) + "x" + Math.floor(
                    e.flags.exactDimensions.height
                )
        }
        ...
        if (a.lineCount > 1) {
            ...
            o.add(d),
            o.moveTo(
                (e.width - a.boundingBox.width) / 2,
                (e.height - a.boundingBox.height) / 2,
                null
            );
        return r
    }
    ...
    function s(e) {
        var t;
        t = null == e || null == e.nodeType
            ? A.vars.resizableImages
            : [e];
        for (var r in t) 
            if (t.hasOwnProperty(r)) {
                ...
                if (n.holderData) {
                    ...
                    if (a) {
                        ...
                        i.textmode && "exact" == i.textmode && (
                            i.exactDimensions = a,
                            h.dimensions = i.dimensions
                        ),
        ...
        if (e.holderData) {
            ...
            if (t) {
                ...
                n.fluidWidth && !n.fluidHeight
                    ? (
                        n.mode = "width",
                        n.ratio = n.initialDimensions.width / parseFloat(r.dimensions.height)
                    )
                    : !n.fluidWidth && n.fluidHeight && (
                        n.mode = "height",
    ...
    function g(e, r) {
        if (t.XMLSerializer){{var n=new XMLSerializer,i="",o=r.stylesheets;e.querySelector("defs")}if(r.svgXMLStylesheet){for(var a=(new DOMParser).parseFromString("<xml />","application/xml"),l=o.length-1;l>=0;l--){var s=a.createProcessingInstruction("xml-stylesheet",'href="'+o[l]+'" rel="stylesheet"');a.insertBefore(s,a.firstChild)}var d=a.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8" standalone="yes"');a.insertBefore(d,a.firstChild),a.removeChild(a.documentElement),i=n.serializeToString(a)}var h=n.serializeToString(e);return h=h.replace(/\&amp;(\#[0-9]{2,}\;)/g,"&$1"),i+h}}function p(
            e,
            t
        ) {
            var r = {};
            ...
            k = {
                ...
                run: function (e) {
                    ...
                    -1 === A
                        ...
                        .join(",")
                        .indexOf(o.renderer) && (
                            o.renderer = A.setup.supportsSVG
                                ? "svg"
                    ...
                    o.noFontFallback = a.noFontFallback
                        ? a.noFontFallback
                        : !1;
                    ...
                    for (c = 0; c < h.length; c++) {
                        ...
                        var M = null != z.data && 0 === z
                                .data
                                .indexOf(a.domain),
                            D = null != z.dataSrc && 0 === z
                                .dataSrc
                                .indexOf(a.domain);
                        M
                            ? r(a, o, z.data, O)
            ...
            L = function () {
                ...
                return function (r) {
                    ...
                    t.fillRect(
                        0,
                        0,
                        A.dpr(n.children.holderBg.width),
                        A.dpr(n.children.holderBg.height)
                    );
                    {
                        var i = n.children.holderTextGroup;
                        i.properties
                    }
                    t.font = i.properties.font.weight + " " + A.dpr(i.properties.font.size) + i.properties.font.units +
                            " " + i.properties.font.family + ", monospace",
            ...
            O = function () {
                if (t.XMLSerializer) {
                    ...
                    function (t, n) {
                        ...
                        var k = "data:image/svg+xml;base64," + btoa(
                            unescape(encodeURIComponent(g(e, n)))
                        );
                        return k
                    }
                }
        ...
        for (var F in A.flags) 
            A
                .flags
                .hasOwnProperty(F) && (A.flags[F].match = function (e) {
        ...
        function () {
            ...
            A.setup.ratio = e / r,
            E.createElementNS && E
                .createElementNS(C, "svg")
                .createSVGRect && (A.setup.renderer = "svg", A.setup.supportsSVG = !0)
        }(),
        e(k, "Holder", t),
        t.onDomReady && t.onDomReady(function () {
            ...
            t.addEventListener
                ? (
                    t.addEventListener("resize", x, !1),
                    t.addEventListener("orientationchange", x, !1)
                )
                : t.attachEvent("onresize", x),
            "object" == typeof t.Turbolinks && t
                .document
