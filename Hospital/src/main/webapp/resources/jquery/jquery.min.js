...
function (a, b) {
        ...
        var s = function (a) {
                ...
                return g !== n && 9 === g.nodeType && g.documentElement
                    ? (
                        ...
                        (c.qsa = $.test(g.querySelectorAll)) && (jb(function (a) {
                            o
                                .appendChild(a)
                                .innerHTML = "<a id='" + u + "'></a><select id='" + u + "-\f]' msallowcapture='" +
            ...
            d = gb.selectors = {
                ...
                filter: {
                    ...
                    PSEUDO: function (a, b) {
                        var c,
                            e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || gb.error(
        ...
        m.extend({
            dir: function (a, b, c) {
                var d = [],
                    e = a[b];
                while (
                    e && 9 !== e.nodeType && (void 0 === c || 1 !== e.nodeType || !m(e).is(c))
                ) 
        ...
        m.event = {
                ...
                if (r) {
                    ...
                    while (h--) 
                        ...
                        o && (
                            ...
                            (n = g[o]) || (n = g[o] = [], n.delegateCount = 0, j.setup && j.setup.call(a, d, p, k) !== !1 || (
                                a.addEventListener
            ...
            trigger: function (b, c, d, e) {
                ...
                if (
                    h = l = d = d || y,
                    3 !== d.nodeType && 8 !== d.nodeType && !$.test(p + m.event.triggered) && (
        ...
        k.focusinBubbles || m.each({
            ...
            var c = function (a) {
                m
                    .event
                    .simulate(b, a.target, m.event.fix(a), !0)
            };
            m
                .event
                .special[b] = {
        ...
        var eb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|fo" +
                    ...
                    if (f = a[q], f || 0 === f) 
                        if ("object" === m.type(f)) 
                            ...
                            if (
                                ...
                                while (e--) 
                                    m.nodeName(j = f.childNodes[e], "tbody") && !j.childNodes.length && f.removeChild(
                                        j
                                    )
                            }
                    ...
                    if (l && (
                        ...
                        if (f) 
                            for (h = g[g.length - 1].ownerDocument, m.map(g, yb), j = 0; f > j; j++) 
                                d = g[j],
                                ob.test(d.type || "") && !m._data(d, "globalEval") && m.contains(h, d) && (
                                    d.src
            ...
            if (
                ...
                function i() {
                    ...
                    c && c.style && (
                        ...
                        d.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
                        c.appendChild(d).appendChild(b),
                        b.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box" +
                                ";display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:" +
                                "absolute",
                        e = f = !1,
                        h = !0,
                        a.getComputedStyle && (
                            ...
                            i.style.cssText = b.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
            ...
            m.cssHooks[b] = {
                ...
                set: function (a, c, d) {
                    ...
                    return Wb(
                        ...
                        c,
                        d
                            ? Xb(a, b, d, k.boxSizing && "border-box" === m.css(a, "boxSizing", !1, e), e)
                            : 0
                    )
                }
            }
        ...
        k.opacity || (m.cssHooks.opacity = {
            ...
            set: function (a, b) {
                ...
                c.zoom = 1,
                (b >= 1 || "" === b) && "" === m.trim(f.replace(Mb, "")) && c.removeAttribute && (
            ...
            .extend({
                val: function (a) {
                        ...
                        e = this[0];
                    {
                        ...
                        if (e) 
                            return b = m.valHooks[e.type] || m.valHooks[
                                e
                                    .nodeName
                                    .toLowerCase()
                            ],
        ...
        m
            ...
            .extend(
                ...
                a.attachEvent && a.attachEvent("onunload", function () {
                    for (var a in Xc) 
                        Xc[a](void 0, !0)
                }), k.cors = !!Yc && "withCredentials" in Yc, Yc = k.ajax = !!Yc, Yc && m.ajaxTransport(
                    function (a) {
