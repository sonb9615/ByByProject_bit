              ...
              htmls.push("등록된 댓글이 없습니다.");
                         ...
                         $(result).each(function(){
                            ...
                            /*  htmls += '<span class="d-block">'; */
                             ...
                             htmls += '<a href="javascript:void(0)"  onclick="fn_editReply(' + this.commentno + ', \'' + this.comm_date + '\', \'' + (this.comm_content).replace(/(?:\r\n|\r|\n)/g, '') + '\' )" style="padding-right:5px">수정</a>';
...
<body>
	...
	<section>
		...
		<br>
			...
			<br>
			<p id="secondH">${ symptom.ctg_name }&emsp;작성자: ${ symptom.memberid }&emsp;${ symptom.wrt_date }</p>
			<span id="vcnt">조회수 : ${ symptom.viewcnt }</span> <br>
			<hr>
			<br> <br>
			<table id="content">
				...
				<tr>
					...
					<td>${fn:replace(symptom.content,cn,br)}
					<br> <br> <img
						src="${pageContext.request.contextPath}/resources/imageUploadSym/${symptom.file_name_key }"
						name="img" id="img" class="img" alt="${ symptom.file_name_key }" /></td>
				</tr>
