      ...
      <div align="center">
         ...
         <form method="post" enctype="multipart/form-data"
            ...
            <table>
               ...
               <tr>
                  <th width="23%">제목</th>
                  <td><input type="text" name="title" value="${ symptom.title }" autofocus="autofocus" style="width: 100%;"></td>
               </tr>
               <tr>
                  <th width="23%">카테고리</th>
                  <td><select id="category" name="ctg_no"></select></td>
               </tr>
               <tr>
                  <th width="23%">내용</th>
                  <td><textarea rows="15" name="content" style="width:100%;">${ symptom.content }</textarea></td>
               </tr>
               <tr>
					<th scope="row">첨부파일</th>
					<td colspan="3" id="file_td"><a
						href='${pageContext.request.contextPath}/resources/imageUploadSym/${ symptom.file_name_key }'
						id='image' name='image'>${ symptom.file_name_key }</a>
						<button type='button' name="delete" class='btn black ml15'
							style='padding: 3px 5px 6px 5px;'
							onclick='javascript:setDeleteFile("${ symptom.file_name_key }")'>X</button>
