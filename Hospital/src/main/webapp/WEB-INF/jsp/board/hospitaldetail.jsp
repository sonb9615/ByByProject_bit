	...
	<section>
		<div align="center">
			...
			<table>
				...
				<tr>
					<th width="25%">내용</th>
					<td>${ hospital.content }<br><img src="${pageContext.request.contextPath}/resources/imageUpload/${ hospital.file_name_key }"  name="img" id="img" class="img" alt="${ hospital.file_name_key }"/></td>
				</tr>
				<tr>
