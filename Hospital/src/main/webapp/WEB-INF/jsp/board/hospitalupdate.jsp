      ...
      <div align="center">
         ...
         <form method="post" enctype="multipart/form-data"
            ...
            <table>
               ...
               <tr>
                  <th width="23%">제목</th>
                  <td><input type="text" name="title" value="${ hospital.title }" autofocus="autofocus"></td>
               </tr>
<!--                <tr> -->
<!--                   <th width="23%">카테고리</th> -->
...
<!--                </tr> -->
               <tr>
                  <th width="23%">내용</th>
                  <td><textarea rows="5" cols="80" name="content" >${ hospital.content }</textarea></td>
               </tr>
               </tr>
                  <th scope="row">첨부파일</th>
                  <td colspan="3" id="file_td">
                  <a href='${pageContext.request.contextPath}/resources/imageUpload/${ hospital.file_name_key }' id='image' name='image'>${ hospital.file_name_key }</a>
                  <button type='button' name="delete" class='btn black ml15' style='padding:3px 5px 6px 5px;' onclick='javascript:setDeleteFile("${ hospital.file_name_key }")'>X</button>
