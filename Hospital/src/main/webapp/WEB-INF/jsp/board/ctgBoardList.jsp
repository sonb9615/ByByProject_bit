...
<body>
   ...
   <section>
      ...
      <div id="divCtg"></div>
      <li id="total"><a href="${pageContext.request.contextPath}/hospitalboard" id="end">전체</a></li>
      </ul></div>
         <br>
...
<%--                   <td>${ hospital.no }</td>  --%>
         ...
         <br>
         <button id="writeBtn" class="btn btn-default">새글등록</button>
      </div>
      <div id="pageNum">
         <ul class="btn-group pagination">
            <c:if test="${pageMaker.prev }">
               <li>
                  <a href="${ pageContext.request.contextPath }/category/${ ctg_name }${ pageMaker.makeQuery(pageMaker.startPage - 1) }"><i class="fa fa-chevron-left"></i>이전</a>
               </li>
            </c:if>
            <c:forEach begin="${ pageMaker.startPage }" end="${ pageMaker.endPage }" var="idx">
               <li>
                  <a href="${ pageContext.request.contextPath }/category/${ ctg_name }${ pageMaker.makeQuery(idx) }"><i class="fa">${ idx }</i></a>
               </li>
            </c:forEach>
            <c:if test="${ pageMaker.next && pageMaker.endPage>0 }">
               <li>
                  <a href="${ pageContext.request.contextPath }/category/${ ctg_name }${ pageMaker.makeQuery(pageMaker.endPage+1) }"><i class="fa fa-chevron-right"></i>다음</a>
               </li>
            </c:if>
         </ul>
      </div>
