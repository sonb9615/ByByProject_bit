         ...
         <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
               <ul class="nav navbar-nav">
                  <li><a href="${pageContext.request.contextPath}/search">병원검색</a></li>
                  <li><a href="${pageContext.request.contextPath}/hospitalboard">병원게시판</a></li>
                  <li><a href="${pageContext.request.contextPath}/symptomboard">증상게시판</a></li>
                  
                  
                  
                  <li class="dropdown"><a onclick="doActiontp()" href="#"  class="dropdown-toggle"
