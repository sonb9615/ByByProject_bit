            ...
            <div class="container">
               <div class="navbar-header">
                  ...
                  <button type="button" class="navbar-toggle collapsed"
                     ...
                     <nav id="navigation-list" class="to">
                        <ul>
                           <li><a href="${pageContext.request.contextPath}/search" class="tog">Search</a></li>
                           <li><a href="${pageContext.request.contextPath}/hospitalboard" class="tog">Hospital Board</a></li>
                           <li><a href="${pageContext.request.contextPath}/symptomboard" class="tog">Symptom Board</a></li>
                           <li><a onclick="doActiontp()" class="tog">MyPage</a></li>
                           <c:choose>
                           <c:when test="${ empty loginVO }">
                           <li><a href="${ pageContext.request.contextPath }/member/join" class="tog">Join</a></li>
                           <li><a href="${ pageContext.request.contextPath }/login" class="tog">Login</a></li>
                           </c:when>
                           <c:otherwise>
                           <li><a href="${ pageContext.request.contextPath }/logout" class="tog">Logout</a></li>
                           </c:otherwise>
                           </c:choose>
                        </ul>
                     </nav>
